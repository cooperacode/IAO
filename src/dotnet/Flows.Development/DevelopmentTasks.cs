...
/// <summary>
/// Constants used by the development flow.
/// </summary>
public static partial class DevelopmentTasks
{
    ...
    /// a compiler error instead of a key that's never read.
    /// </summary>
...
/// <summary>
/// Support for the development flow. Guards, termination, and other utility functions that don't
/// fit in the main flow. These are private to the harness and not part of the public
