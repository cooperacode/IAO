...
// wires the happy-path prefix only:
...
// discover/product retry in place on evaluator failure (see SpecificationTasks) — the
// deterministic evaluators are the gate, so no envelope-arg validator applies here.
